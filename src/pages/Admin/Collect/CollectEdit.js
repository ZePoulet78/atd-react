...
const CollectEdit = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            collectService.getCollectById(id)
                .then(res => {
                    setCollect(res.data);
                })
                .catch(err => console.log(err));
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="date" className="form-control" name="date" value={collect.date} onChange={onChange} />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="id_vehicule" className="form-label">Véhicule</label>
                            <select className="form-select" name="id_vehicule" value={collect.id_vehicule} onChange={onChange}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="id_user" className="form-label">Chauffeur</label>
                            <select className="form-select" name="id_user" value={collect.id_user} onChange={onChange}>
