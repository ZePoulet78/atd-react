...
const MaraudeAdd = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        console.log(collect);
        maraudeService.addMaraude(collect)
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="date" className="form-control" name="maraud_date" onChange={onChange} />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="departure_time" className="form-label">Heure de départ</label>
                            <input type="time" className="form-control" name="departure_time" onChange={onChange} />
                        </div>
                        <div>
                            <label htmlFor="return_time" className="form-label">Heure de retour</label>
                            <input type="time" className="form-control" name="return_time" onChange={onChange} />
                        </div>
                        <div className="mb-3">
